document.addEventListener("DOMContentLoaded", function () {
    ...
    // "Play Again" button
    const playAgainButton = document.getElementById("play-again2");
...
function closeNewPopup() {
 ...
 function showPlayAgainButtonAi() {
  const playAgainButton = document.getElementById("play-again2");
  ...
  playAgainButton.addEventListener("click", function() {
    ...
    document.getElementById("player-x-score1").innerText =  "X: " + playerXScore;
  document.getElementById("player-o-score1").innerText =  "O: " + playerXScore;
    gameAreas.forEach((e)=>{
      e.innerText='';
    })
    document.getElementById("play-again2").style.display='none';
 ...
 function sendData(matchDate, Difficulty, matchResultt){
  let data={
  ...
  // window.locaton = "script.php"+my_jsonl;
  fetch("script.php",{
    "method" : "POST",
    "headers" : {
